export const PROJECT_CREATE_WITH_AI_REQUEST = 'PROJECT_CREATE_WITH_AI_REQUEST';
export const PROJECT_CREATE_WITH_AI_SUCCESS = 'PROJECT_CREATE_WITH_AI_SUCCESS';
export const PROJECT_CREATE_WITH_AI_FAIL = 'PROJECT_CREATE_WITH_AI_FAIL';
export const PROJECT_CREATE_WITH_AI_RESET = 'PROJECT_CREATE_WITH_AI_RESET';
